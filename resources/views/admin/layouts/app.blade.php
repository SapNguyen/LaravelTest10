                                            ...
                                            <div class="card z-index-2 mt-4">
                                                <div class="card-body mt-n5 px-3">
                                                    ...
                                                    <p class="text-sm ms-2"> (<span
                                                            class="font-weight-bolder">+11%</span>) than last week </p>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-3 py-3 ps-0">
                                                                <div class="d-flex mb-2">
                                                                    ...
                                                                    <p class="text-xs my-auto font-weight-bold">Users
                                                                    </p>
                                                                </div>
                                                                <h4 class="font-weight-bolder">42K</h4>
                                                                <div class="progress w-75">
                                                                    <div class="progress-bar bg-dark w-60"
                                                            ...
                                                            <div class="col-3 py-3 ps-0">
                                                                <div class="d-flex mb-2">
                                                                    <div
                                                                        ...
                                                                        <i
                                                                            class="material-icons opacity-10">ads_click</i>
                                                                    </div>
                                                                ...
                                                                <div class="progress w-75">
                                                                    <div class="progress-bar bg-dark w-90"
                                                            ...
                                                            <div class="col-3 py-3 ps-0">
                                                                <div class="d-flex mb-2">
                                                                    <div
                                                                        ...
                                                                        <i
                                                                            class="material-icons opacity-10">receipt</i>
                                                                    </div>
                                                                    <p class="text-xs mt-1 mb-0 font-weight-bold">Sales
                                                                    </p>
                                                                </div>
                                                                <h4 class="font-weight-bolder">399$</h4>
                                                                <div class="progress w-75">
                                                                    <div class="progress-bar bg-dark w-30"
                                                            ...
                                                            <div class="col-3 py-3 ps-0">
                                                                <div class="d-flex mb-2">
                                                                    <div
                                                                        ...
                                                                        <i
                                                                            class="material-icons opacity-10">category</i>
                                                                    </div>
                                                                    <p class="text-xs mt-1 mb-0 font-weight-bold">Items
                                                                    </p>
                                                                </div>
                                                ...
                                                <div class="col-lg-6 mb-lg-0 mb-4">
                                                    <div
                                                        ...
                                                        <a href="https://www.creative-tim.com"
                                                            class="font-weight-bold" target="_blank">Creative Tim</a>
                                                        for a better web.
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <ul
                                                        ...
                                                        <li class="nav-item">
                                                            <a href="https://www.creative-tim.com"
                                                                class="nav-link text-muted" target="_blank">Creative
                                                                Tim</a>
                                                        </li>
                                                        <li class="nav-item">
